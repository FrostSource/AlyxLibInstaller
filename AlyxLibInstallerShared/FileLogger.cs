namespace AlyxLibInstallerShared
{
    ...
    public static class FileLogger
    {
        ...
        /// </summary>
        public static bool HasTooManyLogFiles(int maxLogFiles = DefaultMaxLogFiles)
        {
            try
            {
                return LogFileCount > maxLogFiles;
            }
            catch
            {
                return false;
        ...
        /// <summary>
        /// Returns true if the number of log files exceeds the threshold and assigns the log file count.
        /// </summary>
        public static bool HasTooManyLogFiles(out int logFileCount, int maxLogFiles = DefaultMaxLogFiles)
        {
            try
            {
        ...
        /// </summary>
        public static void CleanupOldLogs(int maxLogFiles = DefaultMaxLogFiles)
        {
            try
            {
            ...
            {
                Log(ex, "Failed to cleanup old logs");
            }
        }
    }
}